...
<div class="main margin-top-20">
	<div class="mainPart">
		<div class="widget">
			<h4 class="text-center">Update {{ $user->first_name . ' ' . $user->last_name }} Profile</h4>
			<p class="text-center">You can change your profile & every information</p>
			<div class="upro">
				<div class="card-body">
					@if(session('success'))
                    ...
                    <form method="POST" action="{{ route('user.updateProfile') }}">
                        ...
                        <div class="form-group row">
                            <label for="street_address" class="col-md-4 col-form-label text-md-right">{{ __('State Address *') }}</label>

                            <div class="col-md-6">
                                <textarea name="street_address" id="" cols="30" rows="5" class="form-control @error('street_address') is-invalid @enderror" name="street_address" autocomplete="street_address" autofocus>{{ $user->street_address }}</textarea>
